...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@SatanAssociation"))
        else:
            ...
            await client.join_chat("SatanAssociation")
    except KeyError:
        pass
    try:
